...
unsigned int nStakeMaxAge = 60 * 60 * 24 * 30;	// stake age of full weight: 100d
unsigned int nStakeTargetSpacing = 120;			// 60 sec block spacing

int64 nChainStartTime = 1415850670;
...
int64 GetProofOfWorkReward(int nHeight, int64 nFees, uint256 prevHash)
{
	...
	if(nHeight == 1)
	{
		nSubsidy = 1000000 * COIN;	// 1 Million coins, that all pow coins
		return nSubsidy + nFees;
	}

    // Subsidy is cut in half every 50,000 blocks
...
bool CBlock::ConnectBlock(CTxDB& txdb, CBlockIndex* pindex, bool fJustCheck)
{
    ...
    bool fEnforceBIP30 = true; // Always active in MedicCoin
    bool fStrictPayToScriptHash = true; // Always active in MedicCoin
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "MedicCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "November 13, 2014, Medicoin Is Created 1415850670.";
        CTransaction txNew;
        ...
        block.nVersion = 1;
        block.nTime    = 1415850670;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = 1651181;
        ...
        assert(block.hashMerkleRoot == uint256("5185ed98fc1f0af062377e203fae85d6c16bdcbf0607703d41f4bfd36e587f3f"));
